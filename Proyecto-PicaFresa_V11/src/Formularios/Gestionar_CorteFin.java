...
public class Gestionar_CorteFin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 160, 620, 141));
    ...
    public void setCampoSave(String Save){
       txtTotal.setText(Save);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gestionar_CorteFin().setVisible(true);
            }
        });
    }
